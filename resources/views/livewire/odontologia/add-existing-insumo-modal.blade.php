            ...
            <div class="modal-body">
                <form wire:submit.prevent="addInsumoToConsultorio" id="formularioAgregarExistente">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control text-center @error('cantidad') is-invalid @enderror" id="form-existente-agregar-cantidad" wire:model="cantidad" min="0" max="1000" placeholder="0">
