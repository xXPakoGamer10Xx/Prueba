...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-cafe text-white">
        <div class="container-fluid container">
            ...
            <a class="navbar-brand logo px-5" href="{{ route('ginecologia.index') }}">
            <img src="/img/logo_IB.svg" alt="Logo Edo. Mex.">
                ...
                <div class="navbar" id="navbarNav">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('ginecologia.index') }}">Inicio</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('ginecologia.material') }}">Material</a>
                        </li>
                        <li class="nav-item">
